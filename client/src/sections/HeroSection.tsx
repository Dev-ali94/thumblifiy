        ...
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            >
                ...
                <p className="flex items-center gap-1">
                    <span>Build Your First Thumbnial Free</span>
            ...
            >
                AI tumbnail genrater for your{" "}
                <span className="move-gradient px-3 rounded-xl text-nowrap">Video</span>
            </motion.h1>
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Stop wasting hours on design.Get high converting tumbnail in second with your advanced AI</motion.p>
